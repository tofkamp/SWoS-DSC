...
You will need the mikrotik_swos library from https://github.com/y-martin/pkg-python3-mikrotik-swos. Remove all other files, only the mikrotik_swos directory is needed.
